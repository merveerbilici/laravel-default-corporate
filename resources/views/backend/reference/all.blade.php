...
<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
  	...
  	<div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5">Referanslar</h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        	...
        	<li class="breadcrumb-item">
        	  <a href="" class="text-muted">Referanslar</a>
        	</li>
        </ul>
        <!--end::Breadcrumb-->
    	</div>
    ...
    <div class="card card-custom gutter-b">
      <div class="card-header">
        <div class="card-title">
          <h3 class="card-label">Referanslar</h3>
        </div>
        <div class="card-toolbar">
          <a href="{{route('reference.create')}}" class="btn btn-sm btn-light-success font-weight-bold">
            <i class="flaticon2-plus"></i> Referans Ekle
          </a>
        </div>
      </div>
      <div class="card-body">
        <table class="table table-hover mb-6">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="/upload/reference/{{$reference->image}}" class="h-10 align-self-end"></td>
              ...
              <td>
                <a href="{{route('reference.edit', ['id' => $reference->id])}}" class="btn btn-sm btn-light-primary font-weight-bold mr-2">Düzenle</a>
                <button type="button" class="btn btn-sm btn-light-danger font-weight-bold mr-2 destroy" data-id="{{$reference->id}}">Sil</button>
              </td>
            </tr>
            @endforeach
          </tbody>

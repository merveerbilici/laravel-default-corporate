...
class BlogCategory extends Model
{
    ...
    protected $fillable = ['name', 'description', 'slug', 'order', 'image', 'color', 'is_active', 'created_by', 'deleted_by', 'seo_title', 'seo_description', 'show_index', 'show_header', 'show_footer'];

...
class Service extends Model
{
    ...
    protected $fillable = ['title', 'description', 'content', 'slug', 'order', 'image', 'is_active', 'created_by', 'deleted_by', 'seo_title', 'seo_description', 'show_index', 'show_header', 'show_footer'];
